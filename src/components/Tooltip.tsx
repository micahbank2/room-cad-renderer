      ...
      {open &&
        createPortal(
          <div
            ref={tooltipRef}
            role="tooltip"
            className="fixed z-[100] pointer-events-none font-mono text-[10px] text-text-primary bg-obsidian-highest border border-outline-variant/30 px-2 py-1 rounded-sm shadow-lg flex items-center gap-2"
            style={
              coords
          ...
          >
            <span>{content}</span>
            {shortcut && (
              <kbd className="font-mono text-[9px] text-accent-light bg-obsidian-base px-1 py-0.5 rounded-sm border border-outline-variant/20">
                {shortcut}
              </kbd>
            )}
          </div>,
