...
export function GestureChip({ mode }: { mode: "2d" | "3d" }) {
  ...
  return (
    <div
      className="glass-panel rounded-lg px-2 py-1 flex items-center gap-2 text-muted-foreground/80 font-mono text-sm absolute bottom-2 left-2 z-10 pointer-events-auto"
