...
export const HELP_INDEX: HelpIndexEntry[] = [
  ...
  // ─── Library + 2D ─────────────────────────────────────────────────
  {
    ...
    body: "Click LIBRARY then ADD PRODUCT. Drop an image, name it, pick a category, enter dimensions in feet.",
  ...
  },
  {
    ...
    body: "Check SKIP DIMENSIONS to upload products without sizes. They render as a placeholder dashed box.",
  ...
  },
  {
    ...
    body: "Adjust snap in the sidebar: OFF, 3 INCH, 6 INCH, or 1 FOOT. Toggle grid visibility too.",
  ...
  // ─── 3D + Walk + Rooms ────────────────────────────────────────────
  {
    ...
    section: "3d",
    heading: "View modes",
    body: "2D PLAN is top-down, 3D VIEW shows rendered scene, SPLIT is side-by-side, LIBRARY browses products.",
