...
- [ ] **TOKEN-FOUNDATION** — Replace the Obsidian CAD palette with Pascal's oklch token system, swap fonts, soften the radius scale, and ship light + dark dual-mode. **Phase 71.**
