...
- [ ] **Phase 34: User-Uploaded Textures** — Jessica uploads JPEG/PNG/WebP with real-world tile size; applies to walls/floors/ceilings; 2048px downscale + SHA-256 dedup + orphan fallback
...
**Plans**: TBD (est. 2 plans: instrumentation harness + root-cause investigation, then fix informed by findings. DO NOT schedule the fix plan before the root-cause plan lands)
**UI hint**: no
