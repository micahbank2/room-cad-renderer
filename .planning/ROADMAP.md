...
**Plans:** 4 plans
- [ ] 46-01-PLAN.md — Wave 0 RED test scaffolding (8 test files + pure-function stubs)
- [ ] 46-02-PLAN.md — Wave 1 pure logic + uiStore additions (treeBuilder, wallLabels, hiddenIds, pendingCameraTarget)
...
| 46. Rooms Hierarchy Sidebar Tree | 0/4 | Planned | - |
